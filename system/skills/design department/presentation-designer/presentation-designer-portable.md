...
Use the canonical Portal Designer instead:

- `system/skills/design department/portal-designer/SKILL.md`
- `system/skills/design department/portal-designer/agents/openai.yaml`

Canonical role name: `portal-designer`
