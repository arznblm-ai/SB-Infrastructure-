...
- an `Iteration Review` artifact when operating inside department orchestration
...
- Department handoff contract: [../references/artifact-handoff-model.md](../references/artifact-handoff-model.md)
- Department quality gates: [../references/quality-gates.md](../references/quality-gates.md)
