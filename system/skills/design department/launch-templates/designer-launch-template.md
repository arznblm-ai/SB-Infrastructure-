...
Используй этот шаблон для чистого запуска `Presentation Designer`.

Важно: агент stateless. Он работает только с теми файлами и комментариями, которые перечислены в этом запуске.

## Роль

Ты работаешь по инструкции из [presentation-designer/SKILL.md](../presentation-designer/SKILL.md).
