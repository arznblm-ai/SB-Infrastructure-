...
m["D22"] = 0.0; m["E22"] = "=E21*D22"; m["D22"].number_format = "0%"
m["D23"] = 0.0; m["E23"] = "=(E21+E22)*D23"; m["D23"].number_format = "0%"
m["E24"] = "=E21+E22+E23"
...
notes = [
    ...
    ("Ставки: рейт-карта студии от 18.08.2026 (лист EXPENSES), комиссия и налоги в D22/D23 - 0% до решения (в шаблоне 14.08 были 10% / 15%).", False),
]
