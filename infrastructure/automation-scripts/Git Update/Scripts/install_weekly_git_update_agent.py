...
LABEL = "com.anton.weekly-git-update"
PROJECT_DIR = Path("/Users/anton/AI AGENT FOLDER/Second Brain/infrastructure/Git Update")
PLIST_FILE = Path.home() / "Library" / "LaunchAgents" / f"{LABEL}.plist"
LOG_FILE = Path.home() / "Library" / "Logs" / "weekly-git-update.log"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Install weekly GitHub infrastructure update LaunchAgent.")
...
def install(weekday: int, hour: int, minute: int) -> None:
    runner = PROJECT_DIR / "Scripts" / "run_weekly_git_update.sh"
